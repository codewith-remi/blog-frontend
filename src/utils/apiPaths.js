...
export const API_PATHS = {
  ...
  IMAGE:{
    UPLOAD_IMAGE: "/api/auth/upload-image", // Upload profile pictures
  },
  DASHBOARD:{
  ...
  AI:{
    ...
    GENERATE_BLOG_POST_IDEAS: "/api/ai/generate-ideas", // Generate a blog post idea using AI
    GENERATE_COMMENT_REPLY: "/api/ai/generate-reply", // Generate a reply using AI
    GENERATE_POST_SUMMARY: "/api/ai/generate-summary", // Generate a blog post summary using AI
  },
  POSTS:{
