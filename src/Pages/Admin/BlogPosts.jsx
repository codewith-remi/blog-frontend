...
import DeleleAlertContent from '../../components/DeleteAlertContent'
...
const BlogPosts = () => {
  ...
  const getAllPosts = async (pageNumber = 1) => {
    try{
      ...
      // Map status summary data with fixed labelsand order
  ...
  const deletePost = async (postId) => {
    try{
      ...
      console.log("Error delating blog post:", error )
    }
  }
