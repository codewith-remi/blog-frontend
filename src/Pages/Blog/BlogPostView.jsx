  ...
  const BlogPostView = () => {
    ...
    const [openSummarizedDrawer, setOpenSummarizedDrawer] = useState(false)
        ...
        {blogPostData && (
          <>
            ...
            <div className="grid grid-cols-12 gap-8 relative ">
              <div className="col-span-12 md:col-span-8 relative mx-auto w-full max-w-3xl bg-red-700">
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <button 
                        className="flex items-center justify-center gap-3 bg-gradient-to-r from-sky-500 to-cyan-400 text-xs font-semibold text-white px-5 py-2 rounded-full hover:bg-black hover:text-white cursor-pointer"
                        onClick={() => {
                          if(!user){
            ...
            <Drawer 
              isOpen={openSummarizedDrawer}
              onClose={() => setOpenSummarizedDrawer(false)}
