...
const BlogLandingPage = () => {
  ...
  return (
    <BlogLayout>
      ...
      <div className="flex flex-col md:flex-row items-center gap-8 bg-white rounded-xl shadow-md p-10 mb-10 border border-gray-100">
        {/* Left side: Image */}
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">
            Welcome to <span className="text-sky-500">Remi Blog</span>
          </h2>
          ...
          <button 
            ...
            className="w-[150px] inline-flex items-center bg-black text-white font-medium px-6 py-2.5 rounded-lg shadow-sm transition-transform transform hover:scale-105"
          >
            Read More
          </button>
        </div>
